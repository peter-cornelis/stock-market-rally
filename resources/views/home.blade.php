    ...
    <section class="w-fit mx-auto px-4">
        ...
        <ul class="grid grid-cols-2 md:grid-cols-3 gap-18 text-white mx-auto">
                <li title="aantal transacties" class="text-center py-4 min-w-38 bg-blueFin border border-black/20 rounded shadow">
                    ...
                    <span class="flex w-16 h-16 text-3xl font-bold bg-black/3 justify-center items-center mx-auto my-4 rounded-full border border-black/10">{{ $activeUsers }}</span>
                </li>
                <li title="aantal transacties" class="text-center py-4 min-w-38 bg-notice border border-black/20 rounded shadow">
                    ...
                    <span class="flex w-16 h-16 text-3xl font-bold bg-black/3 justify-center items-center mx-auto my-4 rounded-full border border-black/10">{{ $totalTransactions }}</span>
                </li>
                <li title="eerste speler in ranking" class="text-center py-4 min-w-38 max-w-42 bg-yellow-500 border border-black/20 rounded shadow">
                    ...
                    <span class="block text-xl px-2 wrap-break-word mt-2 mb-1">{{ $firstUser->username}}</span>
                    <span class="inline-block text-sm font-semibold px-2 wrap-break-word bg-white/7 border border-white/40 mx-2 rounded-xl">{{ $firstUser->portfolio_value}}</span>
